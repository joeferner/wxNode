...
public:
  ...
  static v8::Handle<v8::Value> New(const wxTextCtrl* obj);
  static v8::Handle<v8::Value> New(const wxNode_wxTextCtrl* obj);
  static v8::Handle<v8::Value> NewCopy(const wxTextCtrl& obj);
