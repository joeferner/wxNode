...
/*static*/ v8::Handle<v8::Value> wxNode_wxEvent::New(wxNode_wxEvent* obj) {
  v8::HandleScope scope;
...
/*static*/ v8::Handle<v8::Value> wxNode_wxEvent::New(wxEvent* obj) {
  v8::HandleScope scope;
...
/*static*/ v8::Handle<v8::Value> wxNode_wxEvent::NewCopy(wxEvent& obj) {
  return v8::Undefined();
}
