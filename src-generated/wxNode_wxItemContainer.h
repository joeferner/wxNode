...
public:
  ...
  static v8::Handle<v8::Value> New(wxItemContainer* obj);
  static v8::Handle<v8::Value> New(wxNode_wxItemContainer* obj);
  static v8::Handle<v8::Value> NewCopy(wxItemContainer& obj);
