...
/*static*/ v8::Handle<v8::Value> wxNode_wxSizer::New(wxNode_wxSizer* obj) {
  v8::HandleScope scope;
...
/*static*/ v8::Handle<v8::Value> wxNode_wxSizer::New(wxSizer* obj) {
  v8::HandleScope scope;
...
/*static*/ v8::Handle<v8::Value> wxNode_wxSizer::NewCopy(wxSizer& obj) {
  return v8::Undefined();
}
