...
/*static*/ v8::Handle<v8::Value> wxNode_wxSizerFlags::_Border(const v8::Arguments& args) {
  ...
  if(args.Length() == 2 && args[0]->IsNumber() && args[1]->IsNumber()) {
    ...
    self->Border(direction, borderInPixels);
