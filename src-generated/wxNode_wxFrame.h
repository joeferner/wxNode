...
public:
  ...
  static v8::Handle<v8::Value> New(const wxFrame* obj);
  static v8::Handle<v8::Value> New(const wxNode_wxFrame* obj);
  static v8::Handle<v8::Value> NewCopy(const wxFrame& obj);
