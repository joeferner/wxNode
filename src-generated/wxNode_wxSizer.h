...
public:
  ...
  static v8::Handle<v8::Value> New(const wxSizer* obj);
  static v8::Handle<v8::Value> New(const wxNode_wxSizer* obj);
  static v8::Handle<v8::Value> NewCopy(const wxSizer& obj);
