...
public:
  ...
  static v8::Handle<v8::Value> New(const wxKeyEvent* obj);
  static v8::Handle<v8::Value> New(const wxNode_wxKeyEvent* obj);
  static v8::Handle<v8::Value> NewCopy(const wxKeyEvent& obj);
