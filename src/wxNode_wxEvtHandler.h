...
protected:
  virtual void fireEvent(v8::Handle<v8::Object> self, uint32_t iListener, wxEvent& event);
  virtual void addEventListener(v8::Local<v8::Object> self, wxEvtHandler* evtHandler, int eventType, v8::Local<v8::Object> fn, fnNewEvent* NewEvent);
  virtual void addCommandRangeListener(v8::Local<v8::Object> self, wxEvtHandler* evtHandler, int id, int lastId, int eventType, v8::Local<v8::Object> fn, fnNewEvent* NewEvent);
  virtual void addCommandListener(v8::Local<v8::Object> self, wxEvtHandler* evtHandler, int id, int eventType, v8::Local<v8::Object> fn, fnNewEvent* NewEvent);
  virtual void connect(v8::Local<v8::Object> self, wxEvtHandler* evtHandler, int id, int lastId, int eventType, v8::Local<v8::Object> fn, fnNewEvent* NewEvent);
  virtual void connect(v8::Local<v8::Object> self, wxEvtHandler* evtHandler, int eventType, v8::Local<v8::Object> fn, fnNewEvent* NewEvent);
  virtual void connect(v8::Local<v8::Object> self, wxEvtHandler* evtHandler, int id, int eventType, v8::Local<v8::Object> fn, void* userData, wxEvtHandler* eventSink, fnNewEvent* NewEvent);
...
class NodeExEvtHandlerImplWrap : public wxNodeObject, public NodeExEvtHandlerImpl {
public:
...
struct EventProxyData : public wxObject {
  NodeExEvtHandlerImpl* m_evtHandler;
...
protected:
  ...
  static v8::Handle<v8::Value> _EVT_CLOSE(const v8::Arguments& args);
	...
	static v8::Handle<v8::Value> _EVT_WEB_VIEW(const v8::Arguments& args);
